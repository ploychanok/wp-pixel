...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php if(is_singular($post_type = "post")) : true ?>
	...
	<div class="single-post-content post-single white clearfix">
        ...
        <!--    Drink Price Table Here    -->
		<?php
		$args_ingredients = array( 'post_type' => 'ingredients');
		$loop = new WP_Query( $args_ingredients );
		...
		?>
        <?php if(is_singular($post_type = "drinks")) : true ?>
        <table class="w-100">
            <thead>
            <tr>
                <th scope="col"></th>
